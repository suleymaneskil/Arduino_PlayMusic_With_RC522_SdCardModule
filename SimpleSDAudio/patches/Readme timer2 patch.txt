Replace wiring.c in Arduino V.1.0.1 to V.1.0.3 in folder hardware/arduino/cores/arduino/ with the version in this folder to switch core timer functions from timer0 to timer2. 
